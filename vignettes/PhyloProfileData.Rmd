...
# Load data
data("preProcessedTaxonomy")
head(preProcessedTaxonomy)
```
...
D136–D143.
5. Finn, RD. (2014) Pfam: The protein families database. Nucleic Acids Res., 
42, D222-30
...
11. Promponas, VJ. et al. (2000) CAST: an iterative algorithm for the 
